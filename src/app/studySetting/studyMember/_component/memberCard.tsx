  ...
  return (
    <div className={isRequesting ? styles.container : styles.done}>
      ...
      <div className={styles.rightBox}>
        {isRequest ? (
          <p className={styles.nickname}>{requestData?.nickname}님이 함께하길 원하고 있어요</p>
        ) : (
        ...
        <div className={styles.secondRowBox}>
          ...
          {isMember && (
            <Button size="very_small" property="default" onClick={handleOutMember}>
              내보내기
            </Button>
          )}
        </div>
        {isRequesting && (
          <div className={styles.thirdRowBox}>
            <Button size="very_small" onClick={handleDeclineRequest}>
              거절
            </Button>
            <Button size="very_small" onClick={handleAcceptRequest}>
              수락
            </Button>
          </div>
        )}
